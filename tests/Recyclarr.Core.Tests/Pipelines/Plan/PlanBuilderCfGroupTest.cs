...
internal sealed class PlanBuilderCfGroupTest : PlanBuilderTestBase
{
    ...
    public void Build_with_invalid_cf_group_trash_id_reports_error()
    {
        ...
        plan.Outcomes.Should()
            .ContainSingle()
            .Which.Should()
            .BeOfType<RuleValidationOutcome>()
            .Which.Message.Should()
            .Contain("nonexistent-group");
    }
    ...
    public void Build_with_cf_group_no_profiles_skips_group()
    {
        ...
        plan.Outcomes.Should()
            .ContainSingle()
            .Which.Should()
            .Be(new IncompatibleCfGroupOutcome("Test Group", "test-group"));
    }
    ...
    public void Build_with_cf_group_invalid_select_trash_id_reports_error()
    {
        ...
        var outcome = plan.Outcomes.OfType<RuleValidationOutcome>().Should().ContainSingle().Which;
        outcome
            .Should()
            .BeEquivalentTo(
                new RuleValidationOutcome(
                    ...
                    "Select[0]",
                    "CF group 'test-group': Invalid CF trash_id in select: nonexistent-cf",
                    "nonexistent-cf",
                    "PredicateValidator"
                )
            );
    ...
    public void Build_with_cf_group_invalid_exclude_trash_id_reports_error()
    {
        ...
        outcome
            .Message.Should()
            .Contain("nonexistent-cf")
            .And.Contain("Invalid CF trash_id in exclude");
    }
    ...
    public void Build_with_cf_group_excluding_non_default_cf_emits_warning()
    {
        ...
        var outcome = plan.Outcomes.OfType<RuleValidationOutcome>().Should().ContainSingle().Which;
        outcome.Message.Should().Contain("optional-cf").And.Contain("has no effect");
    }
