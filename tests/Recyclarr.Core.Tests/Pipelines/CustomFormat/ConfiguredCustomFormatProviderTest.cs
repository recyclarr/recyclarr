...
internal sealed class ConfiguredCustomFormatProviderTest : CoreIntegrationTestFixture
{
        ...
        diagnostics
            ...
            .Add(
                Arg.Is<AmbiguousProfileReferenceOutcome>(x =>
                    ...
                    && x.TrashId == "shared-qp"
                    && x.ProfileNames.Count == 2
                    && x.ProfileNames[0] == "WEB-2160p"
                    && x.ProfileNames[1] == "WEB-2160p (AMZN DV)"
                )
            );
    }
