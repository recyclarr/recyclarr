...
internal sealed class MediaNamingGuideServiceTest : IntegrationTestFixture
{
    ...
    public void Radarr_naming()
    {
        ...
        Fs.AddSameFileFromEmbeddedResource(
            jsonPath.SubDirectory("naming1").File("radarr_naming1.json"),
            GetType()
        );
        Fs.AddSameFileFromEmbeddedResource(
            jsonPath.SubDirectory("naming2").File("radarr_naming2.json"),
            GetType()
        );
    ...
    public void Sonarr_naming()
    {
        ...
        Fs.AddSameFileFromEmbeddedResource(
            jsonPath.SubDirectory("naming1").File("sonarr_naming1.json"),
            GetType()
        );
        Fs.AddSameFileFromEmbeddedResource(
            jsonPath.SubDirectory("naming2").File("sonarr_naming2.json"),
            GetType()
        );
