...
internal sealed class ConnectionStepView : WizardStepViewBase<ConnectionViewModel>
{
    public ConnectionStepView(ConnectionViewModel viewModel)
    {
        ...
        var nameField = new TextField { Y = Pos.Bottom(nameLabel), Width = 40 };
        ...
        var urlField = new TextField { Y = Pos.Bottom(urlLabel), Width = Dim.Fill() };
        ...
        var apiKeyField = new TextField { Y = Pos.Bottom(apiKeyLabel), Width = Dim.Fill() };
